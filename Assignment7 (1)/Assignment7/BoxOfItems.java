...
public class BoxOfItems extends TimsProduct{
    /** size of items */
    private double size;
    /** quantity of items */
     ...
     */
    private BoxOfItems(String name, double size, int quantity, double cost, double price) {
     ...
     */
    public static BoxOfItems create() {
        ...
        return new BoxOfItems(name, size, quantity, cost, price);
    }
